			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pocmdg-display": {
								"semanticObject": "pocmdg",
								"action": "display",
								"description": "POC Application for SAP Master data Governance",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pocmdg",
									"url": sap.ui.require.toUrl("pocmdg")
								}
							}
						}
					}
